...
public class ProjectActivity extends AppCompatActivity {
        ...
        public void onActivityResult(ActivityResult result) {
            if(result.getResultCode() == RESULT_OK && result.getData() != null){
                ...
                if(mMode.equals("EDIT")){
                    Project mProject = new Project(vId, get, vPrice, vPerception, 1, 0, vAmountConsumption, vConsumptionCycle, 0);
                    int vResult = ProjectDao.updateProject(mProject, getApplicationContext());
                    if(vResult <= 0){
                    ...
                    Project mProject = new Project(mName, vPrice, vPerception, 1, 0, vAmountConsumption, vConsumptionCycle, 0);
                    int vResult = ProjectDao.InsertProject(mProject, getApplicationContext());
                    if(vResult <= 0){
                ...
                Toast.makeText(ProjectActivity.this, mMessage, Toast.LENGTH_SHORT).show();
    ...
    private View.OnClickListener onItemClickListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            mIntent.putExtra("EXTRA_NAME", mProductAdapter.getProjectAt(vPosition).getName());
            mIntent.putExtra("EXTRA_PRICE", mProductAdapter.getProjectAt(vPosition).getPrice());
            mIntent.putExtra("EXTRA_PERCEPTION_PRICE", mProductAdapter.getProjectAt(vPosition).getRating());
            mIntent.putExtra("EXTRA_AMOUNT_CONSUMPTION", mProductAdapter.getProjectAt(vPosition).getAmountConsumption());
